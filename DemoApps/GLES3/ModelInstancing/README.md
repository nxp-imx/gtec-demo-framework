...
Key         | Result
------------|---------------------------------------
Up arrow    | small instance count increase
Down arrow  | small instance count decrease
Left arrow  | instance count decrease
Right arrow | instance count increase
Q           | large instance count decrease
E           | large instance count increase
R           | Toggle rotate on/off
Space       | Set default values
