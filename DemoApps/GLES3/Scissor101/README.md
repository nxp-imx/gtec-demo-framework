...
--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------
--ForceInvalidHeight            |Force a invalid height                                                                                                                                              |Demo
--ForceInvalidWidth             |Force a invalid width                                                                                                                                               |Demo
-x, --DisableX                  |Disable scissoring of X                                                                                                                                             |Demo
-y, --DisableY                  |Disable scissoring of Y                                                                                                                                             |Demo
