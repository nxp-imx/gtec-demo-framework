...
```bash
msdf-atlas-gen -yorigin top -size 37 -type mtsdf -emrange 0.2 -potr -font segoeuib.ttf -imageout MtsdfHeaderFont.png -json MtsdfHeaderFont.json -charset charset.txt
```
