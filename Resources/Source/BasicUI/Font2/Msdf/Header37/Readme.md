...
```bash
msdf-atlas-gen -yorigin top -size 37 -type msdf -emrange 0.2 -potr -font segoeuib.ttf -imageout MsdfHeaderFont.png -json MsdfHeaderFont.json -charset charset.txt
```
