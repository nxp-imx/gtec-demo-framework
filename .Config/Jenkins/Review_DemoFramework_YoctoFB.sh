...
FslBuild.py -t sdk -vv --BuildTime --UseFeatures [EGL,EarlyAccess,OpenCL,OpenCL1.1,OpenGLES2,OpenGLES3,OpenVG] --Variants [WindowSystem=FB] --BuildThreads 4 -- install
