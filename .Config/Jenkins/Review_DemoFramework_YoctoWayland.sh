...
#cd tmp
pushd /home/shared/fsl-release-bsp/build-wayland/tmp
source environment-setup-cortexa9hf-neon-poky-linux-gnueabi
export ROOTFS=/home/shared/jen-rootfs/build-wayland
popd
...
FslBuild.py -t sdk -vv --BuildTime --UseFeatures [EGL,EarlyAccess,OpenCL,OpenCL1.1,OpenGLES2,OpenGLES3,OpenVG] --Variants [WindowSystem=Wayland] --BuildThreads 4 -- install
