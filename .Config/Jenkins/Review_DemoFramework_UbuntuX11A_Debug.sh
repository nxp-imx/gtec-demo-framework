...
FslBuild.py -t sdk -vv --BuildTime --Variants [config=Debug] --UseFeatures [EGL,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenCL,OpenCL1.1,OpenCL1.2,Vulkan,EarlyAccess] -- -j 4
