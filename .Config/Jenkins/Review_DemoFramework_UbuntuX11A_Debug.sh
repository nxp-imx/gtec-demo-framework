...
source prepare.sh  
FslBuild.py -t sdk -vv --BuildTime --Variants [config=Debug] --UseFeatures [EGL,EarlyAccess,OpenCL,OpenCL1.1,OpenCL1.2,OpenCV,OpenCV3,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenVX,OpenVX1.0.1,OpenVX1.1,Vulkan] --BuildThreads 4
