...
# No OpenCV
FslBuild.py --noGitHash --debug -t sdk -vv --BuildTime --UseFeatures [EarlyAccess,EGL,G2D,OpenCL1.2,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenVG,OpenVX,OpenVX1.2,Vulkan,HW_CAMERA_MIPI8X] --Variants [WindowSystem=Wayland] -c install --CMakeInstallPrefix bin
