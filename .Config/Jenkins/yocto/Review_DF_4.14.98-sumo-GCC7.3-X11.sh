...
# No OpenCV, Vulkan
FslBuild.py --debug -t sdk -vv --BuildTime --UseFeatures [EGL,EarlyAccess,G2D,OpenCL1.1,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenVG,OpenVX,OpenVX1.1,HW_CAMERA_MIPI8X] --Variants [WindowSystem=X11] -c install --CMakeInstallPrefix bin
