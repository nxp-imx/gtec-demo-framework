...
# No OpenCV, Vulkan
FslBuild.py --noGitHash --debug -t sdk -vv --BuildTime --UseFeatures [EarlyAccess,EGL,G2D,OpenCL1.2,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenVG,OpenVX,OpenVX1.2,HW_CAMERA_MIPI8X] --Variants [WindowSystem=X11] -c install --CMakeInstallPrefix bin
