...
# all
#FslBuild.py --noGitHash -t sdk -vv --BuildTime --UseFeatures [EGL,Test_RequireUserInputToExit,EarlyAccess,G2D,OpenCL1.1,OpenCV,OpenCV4,OpenGLES2,OpenGLES3,OpenGLES3.1,OpenVG,OpenVX,OpenVX1.2,Vulkan] --Variants [WindowSystem=X11] -c install --CMakeInstallPrefix bin
# No OpenCV, Vulkan
