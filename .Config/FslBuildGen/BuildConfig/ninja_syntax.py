...
class Writer(object):
    ...
    def variable(self, key: str, value: Union[None,str,int,List[str]], indent: int = 0) -> None:
        if value is None:
            return
    ...
    def rule(self, name: str, command: str, description: Optional[str]=None, depfile: Optional[str]=None,
             generator: bool=False, pool: Optional[str]=None, restat: bool=False, rspfile: Optional[str]=None,
             rspfile_content: Optional[str]=None, deps: Optional[str]=None) -> None:
